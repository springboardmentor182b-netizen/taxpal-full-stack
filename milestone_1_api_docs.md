# TaxPal Milestone 1 API Documentation Overview
...
Description: Fetches profile information of the logged-in user.
...
Request Body:
Any of type, category, amount, date
...
Query Parameters:
Optional period = daily|weekly|monthly
