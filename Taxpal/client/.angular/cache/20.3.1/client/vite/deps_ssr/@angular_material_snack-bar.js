...
function isDataSource(value) {
  return value && typeof value.connect === "function" && !(value instanceof import_rxjs10.ConnectableObservable);
}
...
var _ArrayDataSource = class _ArrayDataSource extends DataSource {
  ...
  connect() {
    return (0, import_rxjs11.isObservable)(this._data) ? this._data : (0, import_rxjs11.of)(this._data);
  }
  disconnect() {
  }
};
...
var _FixedSizeVirtualScrollStrategy = class _FixedSizeVirtualScrollStrategy {
  _scrolledIndexChange = new import_rxjs12.Subject();
  /** @docs-private Implemented as part of VirtualScrollStrategy. */
  scrolledIndexChange = this._scrolledIndexChange.pipe((0, import_operators8.distinctUntilChanged)());
...
var _ScrollDispatcher = class _ScrollDispatcher {
  ...
  _scrolled = new import_rxjs12.Subject();
  ...
  scrolled(auditTimeInMs = DEFAULT_SCROLL_TIME) {
    ...
    return new import_rxjs12.Observable((observer) => {
      ...
      const subscription = auditTimeInMs > 0 ? this._scrolled.pipe((0, import_operators8.auditTime)(auditTimeInMs)).subscribe(observer) : this._scrolled.subscribe(observer);
      this._scrolledCount++;
      return () => {
        subscription.unsubscribe();
        this._scrolledCount--;
  ...
  ancestorScrolled(elementOrElementRef, auditTimeInMs) {
    ...
    return this.scrolled(auditTimeInMs).pipe((0, import_operators8.filter)((target) => !target || ancestors.indexOf(target) > -1));
  }
...
var _CdkScrollable = class _CdkScrollable {
  ...
  _destroyed = new import_rxjs12.Subject();
  _renderer = inject(Renderer2);
  _cleanupScroll;
  _elementScrolled = new import_rxjs12.Subject();
  constructor() {
  }
  ngOnInit() {
...
var _ViewportRuler = class _ViewportRuler {
  ...
  _change = new import_rxjs12.Subject();
  /** Used to reference correct document/window */
  _document = inject(DOCUMENT);
  constructor() {
    const ngZone = inject(NgZone);
  ...
  change(throttleTime = DEFAULT_RESIZE_TIME) {
    return throttleTime > 0 ? this._change.pipe((0, import_operators8.auditTime)(throttleTime)) : this._change;
  }
  /** Use defaultView of injected document if available or fallback to global window reference */
  _getWindow() {
    return this._document.defaultView || window;
...
var SCROLL_SCHEDULER = typeof requestAnimationFrame !== "undefined" ? import_rxjs12.animationFrameScheduler : import_rxjs12.asapScheduler;
var _CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  _detachedSubject = new import_rxjs12.Subject();
  /** Emits when the rendered range changes. */
  _renderedRangeSubject = new import_rxjs12.Subject();
  ...
  scrolledIndexChange = new import_rxjs12.Observable((observer) => this._scrollStrategy.scrolledIndexChange.subscribe((index) => Promise.resolve().then(() => this.ngZone.run(() => observer.next(index)))));
  ...
  _viewportChanges = import_rxjs12.Subscription.EMPTY;
  _injector = inject(Injector);
  _isDestroyed = false;
  constructor() {
    super();
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => Promise.resolve().then(() => {
      ...
      this.scrollable.elementScrolled().pipe(
        ...
        (0, import_operators8.startWith)(null),
        // Collect multiple events into one until the next animation frame. This way if
        // there are multiple scroll events in the same frame we only need to recheck
        // our layout once.
        (0, import_operators8.auditTime)(0, SCROLL_SCHEDULER),
  ...
  attach(forOf) {
    ...
    this.ngZone.runOutsideAngular(() => {
      this._forOf = forOf;
      this._forOf.dataStream.pipe((0, import_operators8.takeUntil)(this._detachedSubject)).subscribe((data) => {
...
var _CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  viewChange = new import_rxjs12.Subject();
  /** Subject that emits when a new DataSource instance is given. */
  _dataSourceChanges = new import_rxjs12.Subject();
  ...
  set cdkVirtualForOf(value) {
    ...
    if (isDataSource(value)) {
      ...
      this._dataSourceChanges.next(new ArrayDataSource((0, import_rxjs12.isObservable)(value) ? value : Array.from(value || [])));
    }
  }
  _cdkVirtualForOf;
  /**
  ...
  dataStream = this._dataSourceChanges.pipe(
    ...
    (0, import_operators8.pairwise)(),
    // Use `_changeDataSource` to disconnect from the previous data source and connect to the
    // new one, passing back a stream of data changes which we run through `switchMap` to give
    // us a data stream that emits the latest data from whatever the current `DataSource` is.
    (0, import_operators8.switchMap)(([prev, cur]) => this._changeDataSource(prev, cur)),
    // Replay the last emitted data when someone subscribes.
    (0, import_operators8.shareReplay)(1)
  );
  ...
  constructor() {
    ...
    this._viewport.renderedRangeStream.pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe((range) => {
  ...
  _changeDataSource(oldDs, newDs) {
    ...
    this._needsUpdate = true;
    return newDs ? newDs.connect(this) : (0, import_rxjs12.of)();
  }
...
var _CloseScrollStrategy = class _CloseScrollStrategy {
  ...
  enable() {
    ...
    const stream = this._scrollDispatcher.scrolled(0).pipe((0, import_operators9.filter)((scrollable) => {
...
var _OverlayRef = class _OverlayRef {
  ...
  _injector;
  _renderer;
  _backdropClick = new import_rxjs13.Subject();
  _attachments = new import_rxjs13.Subject();
  _detachments = new import_rxjs13.Subject();
  _positionStrategy;
  _scrollStrategy;
  _locationChanges = import_rxjs13.Subscription.EMPTY;
  _backdropRef = null;
  ...
  _keydownEvents = new import_rxjs13.Subject();
  /** Stream of mouse outside events dispatched to this overlay. */
  _outsidePointerEvents = new import_rxjs13.Subject();
...
var _FlexibleConnectedPositionStrategy = class _FlexibleConnectedPositionStrategy {
  ...
  _positionChanges = new import_rxjs13.Subject();
  /** Subscription to viewport size changes. */
  _resizeSubscription = import_rxjs13.Subscription.EMPTY;
...
var _CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  _overlayRef;
  _templatePortal;
  _backdropSubscription = import_rxjs13.Subscription.EMPTY;
  _attachSubscription = import_rxjs13.Subscription.EMPTY;
  _detachSubscription = import_rxjs13.Subscription.EMPTY;
  _positionSubscription = import_rxjs13.Subscription.EMPTY;
  _offsetX;
  _offsetY;
  _position;
  ...
  attachOverlay() {
    ...
    if (this.positionChange.observers.length > 0) {
      this._positionSubscription = this._position.positionChanges.pipe((0, import_operators9.takeWhile)(() => this.positionChange.observers.length > 0)).subscribe((position) => {
...
var _MatSnackBarRef = class _MatSnackBarRef {
  ...
  _afterDismissed = new import_rxjs15.Subject();
  /** Subject for notifying the user that the snack bar has opened and appeared. */
  _afterOpened = new import_rxjs15.Subject();
  /** Subject for notifying the user that the snack bar action was called. */
  _onAction = new import_rxjs15.Subject();
  /**
...
var _MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  ...
  _onAnnounce = new import_rxjs15.Subject();
  /** Subject for notifying that the snack bar has exited from view. */
  _onExit = new import_rxjs15.Subject();
  /** Subject for notifying that the snack bar has finished entering the view. */
  _onEnter = new import_rxjs15.Subject();
  ...
  exit() {
    if (this._destroyed) {
      return (0, import_rxjs15.of)(void 0);
    }
    this._ngZone.run(() => {
...
var _MatSnackBar = class _MatSnackBar {
  ...
  _attach(content, userConfig) {
    ...
    this._breakpointObserver.observe(Breakpoints.HandsetPortrait).pipe((0, import_operators11.takeUntil)(overlayRef.detachments())).subscribe((state) => {
