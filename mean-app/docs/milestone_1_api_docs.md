...
**Purpose:** Enable users to register, login, and log income/expenses with a basic dashboard.
...
```json
[
  { "id": 101, "type": "income", "category": "salary", "amount": 2000, "date": "2025-09-15" },
  { "id": 102, "type": "expense", "category": "groceries", "amount": 100, "date": "2025-09-15" }
]
```
